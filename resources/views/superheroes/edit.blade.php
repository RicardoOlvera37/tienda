...
<h1 class="text-center mt-2">editar datos de doctor</h1>
<hr>
   ...
   <div class="col-md-6 col-sm-6 col-xs-12">
    ...
    @method('PUT')
     ...
     <div class="form-group ">
      ...
      <input class="form-control" id="Nombre"  name="Nombre" value="{{ $superheroe->nombre }}" placeholder="nombre del medico" type="text"/>
     </div>
     <div class="form-group ">
      ...
      <input class="form-control" id="poder"  name="poder" value="{{ $superheroe->poder }}" placeholder="especilidad" type="text"/>
     </div>
     <div class="form-group ">
      ...
      <input class="form-control" id="creador"  name="creador" value="{{ $superheroe->creador }}" placeholder="Telefono de contacto" type="text"/>
     </div>
     <div class="form-group ">
